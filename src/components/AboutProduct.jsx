      ...
      <div className="flex flex-col gap-5 md:grid grid-cols-5 space-x-5">
        ...
        <div className="col-span-3 space-y-5 py-5">
          ...
          <div className="space-y-2">
            ...
            <p className="border-b text-lg text-gray-600 w-full border-gray-400">NGN 12,000</p>
          </div>
          <div className="space-y-2">
            <p className="text-md font-bold text-gray-500 tracking-wider">
              Brand
            </p>
            <p className="border-b text-lg text-gray-600 w-full border-gray-400">Channels</p>
          </div>
          <div className="space-y-2">
            <p className="text-md font-bold text-gray-500 tracking-wider">
              Quantity
            </p>
            <p className="border-b w-full border-gray-500 font-bold text-xl">1</p>
          </div>
          <div className="space-y-2 w-full">
            <p className="text-md font-bold text-gray-500 tracking-wider">
              Category
            </p>
            <p className="border-b text-lg text-gray-600 w-full border-gray-400">Unisex</p>
          </div>
        </div>
      </div>
    </div>
